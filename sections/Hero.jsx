      ...
      <motion.div variants={slideIn('right', "tween", 0.2, 1)} className="relative w-full md:-mt-[20px] -mt-[12px]">
        <div className="absolute w-full hero-gradient h-[300px] rounded-tl-[140px] z-[0] -top-[30px]"/>
          ...
          <img
            ...
            src="/cover.png"
            alt="cover"
            className="w-full rounded-tl-[140px] sm:h-[500px] object-cover z-10 relative" />

          <a href="#explore">
            <div className="w-full flex justify-end sm:-mt-top-[70px] -mt-[50px] z-10 relative pr-[40px] ">
              <img
